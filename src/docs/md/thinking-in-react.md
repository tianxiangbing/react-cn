...
如果你在执行这步时需要帮助，请参阅 [React 文档](/docs/getting-started.html)。

### 小插曲: props vs state

在React里有两种数据 "模型": props 和 state。明白这二者之间的区别是很重要的；如果你不是很确定它们之间的区别，请概览[React官方文档](/docs/interactivity-and-dynamic-uis.html)
